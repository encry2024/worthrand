...
return [
    ...
    */
    ...
    'backend' => [
        'indented_proposals' => [
            'no_deleted'    =>  'There are no delete Indented Proposals.',
            'delete_indented_proposal_confirm'  => 'Are you sure you want to delete this indented proposal permanently? Anywhere in the application that references this indented proposal\'s id will most likely error. Proceed at your own risk. This can not be un-done.',
        ],

        'buy_and_resale_proposals' => [
            'no_deleted'    =>  'There are no delete Buy and Resale Proposals.',
            'delete_buy_and_resale_proposal_confirm'  => 'Are you sure you want to delete this buy and resale_proposal permanently? Anywhere in the application that references this buy and resale_proposal\'s id will most likely error. Proceed at your own risk. This can not be un-done.',
        ],

        'customers' => [
            'no_deleted'    =>  'There are no delete Customers.',
        ...
        'seals' => [
            'no_deleted'    =>  'There are no delete Seals.',
            'delete_seal_confirm'  => 'Are you sure you want to delete this seal permanently? Anywhere in the application that references this seal\'s id will most likely error. Proceed at your own risk. This can not be un-done.',
        ],

        'aftermarkets' => [
            'no_deleted'    =>  'There are no delete Aftermarkets.',
            'delete_aftermarket_confirm'  => 'Are you sure you want to delete this aftermarket permanently? Anywhere in the application that references this aftermarket\'s id will most likely error. Proceed at your own risk. This can not be un-done.',
        ],

        'projects' => [
            'no_deleted'    =>  'There are no delete Projects.',
        ...
        'general' => [
            ...
            'boilerplate_link'    => 'WorthRand Inventory-CRM System',
            'continue'            => 'Continue',
