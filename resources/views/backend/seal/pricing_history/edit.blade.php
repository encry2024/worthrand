...
@section('content')
{{ html()->modelForm($pricing_history, 'PATCH', route('admin.seal.pricing_history.update', [$seal->id, $pricing_history->id]))->class('form-horizontal')->open() }}
    ...
    <div class="card">
        ...
        <div class="card-footer clearfix">
            <div class="row">
                <div class="col">
                    {{ form_cancel(route('admin.seal.pricing_history.show', [$seal->id, $pricing_history->id]), __('buttons.general.cancel')) }}
                </div><!--col-->
