<div class="col">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-9">
            <input type="text" id="ship_via" name="ship_via" class="form-control" readOnly value="{{ $model->ship_via }}" readOnly>
        </div>
    </div><!--form-group-->
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-9">
            <input type="text" id="insurance" name="insurance" class="form-control" readOnly value="{{ $model->insurance }}" readOnly>
        </div>
    </div><!--form-group-->
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-9">
            <input type="text" id="bank_detail_name" name="bank_detail_name" class="form-control" readOnly value="{{ $model->bank_detail_name }}" readOnly>
        </div>
    </div><!--form-group-->
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-9">
            <textarea type="text" id="bank_detail_address" name="bank_detail_address" class="form-control" readOnly value="{{ $model->bank_detail_address }}" readOnly></textarea>
        </div>
    </div><!--form-group-->
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-9">
            <input type="text" id="bank_detail_account_no" name="bank_detail_account_no" class="form-control" readOnly value="{{ $model->bank_detail_account_no }}" readOnly>
        </div>
    </div><!--form-group-->
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-9">
            <input type="text" id="bank_detail_swift_code" name="bank_detail_swift_code" class="form-control" readOnly value="{{ $model->bank_detail_swift_code }}" readOnly>
        </div>
    </div><!--form-group-->
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-9">
            <input type="text" id="bank_detail_account_name" name="bank_detail_account_name" class="form-control" readOnly value="{{ $model->bank_detail_account_name }}" readOnly>
        </div>
    </div><!--form-group-->
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-9">
            <textarea type="text" id="commission_note" name="commission_note" class="form-control" readOnly value="{{ $model->commission_note }}" readOnly></textarea>
        </div>
    </div><!--form-group-->
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-9">
            <input type="text" id="commission_address" name="commission_address" class="form-control" readOnly value="{{ $model->commission_address }}" readOnly>
        </div>
    </div><!--form-group-->
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-9">
            <input type="text" id="commission_account_number" name="commission_account_number" class="form-control" readOnly value="{{ $model->commission_account_number }}" readOnly>
        </div>
    </div><!--form-group-->
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-9">
            <input type="text" id="commission_swift_code" name="commission_swift_code" class="form-control" readOnly value="{{ $model->commission_swift_code }}" readOnly>
        </div>
    </div><!--form-group-->
</div>